...
from utils.file_handler import txt_loader,pdf_loader,list_with_allowed_type,get_file_md5_hex
...
class VectorStoreService:
    ...
    def load_document(self):
        ...
        allowed_file_path: list[str] = list_with_allowed_type(
        ...
        for path in allowed_file_path:
            ...
            try:
                ...
                logger.error(f"[加载知识库]{path}失败,错误信息:{str(e)}",exc_info=True)#exc_info为true会详细记录报错堆栈，否则仅报错信息本身
                continue
